...
EvitadorDeColisoes::EvitadorDeColisoes(ros::NodeHandle *nh)
  : Node(nh, 10)
{
  laser_scan_sub_ = nh->subscribe("RosAria/sim_lms2xx_1_laserscan", 1, &EvitadorDeColisoes::laserScanCb, this);
...
void EvitadorDeColisoes::laserScanCb(const sensor_msgs::LaserScanConstPtr& msg)
{
  /*
